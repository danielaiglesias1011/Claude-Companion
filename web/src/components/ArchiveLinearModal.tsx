  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Container warning */}
        {isContainerized && (
          <div className="mb-3 p-2.5 rounded-lg bg-pink-500/10 border border-pink-500/20">
            <div className="flex items-start gap-2">
              <svg viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5 text-pink-500 shrink-0 mt-0.5">
