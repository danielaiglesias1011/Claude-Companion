  ...
  return (
    <div className="flex-1 h-full flex flex-col items-center px-3 sm:px-6 pb-6 pb-safe overflow-y-auto overscroll-y-contain">
      ...
      <div className="w-full max-w-[720px]">
        ...
        {pullPrompt && (
          <div className="mt-3 p-3 rounded-[10px] bg-pink-500/10 border border-pink-500/20">
            <div className="flex items-start gap-2.5">
              <svg viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 text-pink-500 shrink-0 mt-0.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs text-cc-fg leading-snug">
                  ...
                  <span className="font-semibold text-pink-500">{pullPrompt.behind} commit{pullPrompt.behind !== 1 ? "s" : ""} behind</span>{" "}
